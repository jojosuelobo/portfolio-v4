  ...
  experience: [
    {
      ...
      description: "Responsável pelo desenvolvimento e manutenção de frameworks de automação de testes utilizando Cypress e Playwright. Implementação de testes de API com Postman e integração com CI/CD.",
