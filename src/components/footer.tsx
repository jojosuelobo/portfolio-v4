    ...
    <footer className="bg-slate-900 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-400 mb-4 max-w-md">
              QA Automation Engineer especializado em garantir a qualidade de software através de 
              testes automatizados e processos ágeis.
            </p>
        ...
        <div className="pt-8 border-t border-slate-800 text-slate-400 text-sm flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-2 md:mt-0">Desenvolvido com Next.js e Tailwind CSS</p>
        </div>
      </div>
    </footer>
  )
